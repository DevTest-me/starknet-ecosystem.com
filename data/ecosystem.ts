...
export const allProjects: Array<Project> = [
  ...
  },
  {
    ...
    network: {
      ...
      medium: "",
      discord: "https://discord.gg/fEQqvyX8e",
      telegram: "",
    },
    isLive: true,
    isTestnetLive: true,
  ...
  {
    id: "cc0812d6-4a0b-41d5-925b-a190489af539",
    name: "Token Hive",
    shortName: "TokenHive",
    description: "A token registry and launchpad that makes Starknet tokens discoverable in integrated apps without requiring liquidity, available on both testnet and mainnet.",
    tags: ["tools", "infrastructure"],
